...
/// Snapshot files live below LocalApplicationData and therefore never need to be committed to Git.
/// </summary>
public sealed class FileSystemDocumentArchive : IDocumentArchive
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var targetDirectory = AppDataPath.GetApplicationDocumentDirectory(applicationId);
